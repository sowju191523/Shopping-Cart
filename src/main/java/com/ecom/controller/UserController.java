...
public class UserController {
	...
	public String addToCart(@RequestParam Integer pid, @RequestParam Integer uid, HttpSession session) {
		...
		if (ObjectUtils.isEmpty(saveCart)) {
			session.setAttribute("errorMsg", "product added to cart failed");
		} else {
			session.setAttribute("succMsg", "product added to the cart");
		}
   ...
   public String updateCartQuantity(@RequestParam String sy,@RequestParam Integer cid)
   {
	...
	public String profile(@ModelAttribute UserDtls user,@RequestParam MultipartFile img,HttpSession session)
	{
	...
	public String changePassword(@RequestParam String newPassword,@RequestParam String currentPassword,Principal p,HttpSession session)
	{
		...
		{
			session.setAttribute("errorMsg","Some thing is wrong on the server");
		}
		else
		{
